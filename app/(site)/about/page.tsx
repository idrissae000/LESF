      ...
      <section style={{ background: 'var(--cream)', padding: '5rem 1.5rem' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <p style={{ color: 'var(--text-muted)', lineHeight: 1.85, fontSize: '0.97rem' }}>
            The Eritrean Scholars Fund is proud to present its first annual scholarship — a $3,000 award given to one deserving North American Eritrean undergraduate or graduate student. Our mission is to provide meaningful financial support and encouragement, recognizing the hard work and potential of our community's rising generation.
          </p>
        </div>
      </section>
