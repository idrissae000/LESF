...
<p style="color:#6b6b6b;font-size:13px;margin-top:32px">Questions? Reply to this email or contact us at <a href="mailto:admin@lonestareritreanscholars.org">admin@lonestareritreanscholars.org</a>.</p>
</body></html>`,
    })
