    ...
    <div className="form-section">
      ...
      <div className="checkbox-field">
        ...
        <label htmlFor="eligibility">
          ...
          I confirm that I am currently enrolled as an undergraduate student, am 18 years of age or older, and identify as North American Eritrean. I understand this scholarship is open to all majors.
        </label>
      </div>
      {errors.eligibility && (
